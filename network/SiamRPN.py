...
from .cls_hrnet import get_hrnet
...
class SiamRPN(nn.Module):
    def __init__(self, backbone):
        ...
        assert backbone in backbone_dict
        backbone_fn = backbone_dict[backbone]

        self.examplar_branch = backbone_fn()
        self.search_region_branch = backbone_fn()
